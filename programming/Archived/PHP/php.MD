<h3> Where to write php code?</h3>
1. in pure php file with extention .php<br>
...
```  
## Comments  are like c++: ``` // و /*...*/ ```<br>        
## To print a statement : use  Echo and PRINT
````HTML
   <?php echo "i like it" ?>
   <?php print "I like it" ?>
````
...
```php
        ...
        ?>
```        
 To combine Strings and variables in and statement use __dot(.)__
```php    
        print $like ." " .$num;
```        
