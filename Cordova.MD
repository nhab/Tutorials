...
|Concept   | Description   |
|:---			|:---|
|		WebView: | app interface is shown through the WebView component,<br>like a browser that displays Web pages (user interface).<br>In fact, WebView is an HTML rendering engine, which renders HTML pages.|
