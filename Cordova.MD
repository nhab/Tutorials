## Cordova
	is a  Free and open source platform for building hybrid mobile applications using HTML, CSS and JavaScript Targetting multiple platforms with one code base
|:---			|:---
